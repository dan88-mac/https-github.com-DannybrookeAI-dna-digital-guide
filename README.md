...
| **Hybrid matrix workflow** | [`hybrid-matrix-runner/`](hybrid-matrix-runner/) + UI at `/hybrid-workflow` — [docs/HYBRID_QUANTUM_MULTIMODAL_WORKFLOW.md](docs/HYBRID_QUANTUM_MULTIMODAL_WORKFLOW.md) |
